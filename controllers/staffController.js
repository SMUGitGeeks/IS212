...
exports.updateApplicationStatus = async (req, res) => {
        ...
        const updateSql = "UPDATE sbrp.application SET role_app_status=? WHERE (rl_id = ?) and (staff_id = ?)";
        connection.query(updateSql, [role_app_status, rl_id, staff_id], (err, result) => {
          if (err) {
            console.error(err);
