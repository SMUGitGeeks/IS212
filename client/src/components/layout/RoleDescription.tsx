...
import { SolutionOutlined, AimOutlined, CheckCircleOutlined, ClockCircleOutlined } from "@ant-design/icons";
                        ...
                        <Space direction="vertical">
                            {
                                roleListing.rl_desc ? 
                                <>
                                    <Divider orientation="left" orientationMargin="0" style={{fontSize: 23}}>Details</Divider>
                                    {roleListing.rl_desc}
                                </> : <></>
                            }
                            <p style={{padding: "2%"}}></p>
                            {
                                ...
                                <>
                                    <Divider orientation="left" orientationMargin="0" style={{fontSize: 23}}>Role Description</Divider>
                                    {roleListing.role_description}
                                </> : <></>
                            }
                        </Space>
                        ...
                        <Space direction="vertical" style={{width: "100%"}}>
                            ...
                            <Space size={[0, 8]} wrap>
                                {missingSkills.map((skill: any) => (
                                    <Tag icon={tagIcon(skill.skill_status)} color={color(skill.skill_status)}>{skill[0]}</Tag>
                                ))}
                            </Space>
