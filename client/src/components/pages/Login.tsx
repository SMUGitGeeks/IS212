...
const Login = ({ loginStaff, loginHR, auth: {user, loading}}:any ) => {
    ...
    return (
        <Container style={{height: '100vh'}}>
            <Row gutter={rowGutterStyle} align='middle' justify="center" style={{height: '100%'}}>
                <Col xs={22} sm={22} md={14} lg={12} xl={10} xxl={8}>
                    <Card>
                        <Space direction="vertical" style={{width: "100%"}}>
                            ...
                            {view === "Staff" ? 
                                <Space direction='vertical' style={{width: "100%"}}>
                                    <Button block type="primary" onClick={loginStaff}>Login</Button>
                                    <Button block type="link" onClick={() => setView("HR")}>Switch to HR Login</Button>
                                </Space>
                            :
                                <Space direction='vertical' style={{width: "100%"}}>
                                    <Button block type="primary" onClick={loginHR}>Login</Button>
                                    <Button block type="link" onClick={() => setView("Staff")}>Switch to Staff Login</Button>
                                </Space>
                            }
                        </Space>
                    </Card>
